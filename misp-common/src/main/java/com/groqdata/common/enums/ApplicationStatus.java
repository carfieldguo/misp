...
public enum ApplicationStatus {
    ...
    APPROVED("Approved", "审核通过", "应用通过平台审核，可正式调用开放接口"),
    
    /** 审核驳回 - 因违规、信息不全等原因未通过审核，需修改后重新提交 */
    REJECTED("Rejected", "审核驳回", "因违规、信息不全等原因未通过审核，需修改后重新提交"),
    
    /** 已删除 - 平台因违规等原因强制删除（不可恢复） */
    DELETED("Deleted", "已删除", "平台因违规等原因强制删除（不可恢复）"),
