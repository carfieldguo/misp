...
import com.groqdata.system.domain.SysNotice;
import com.groqdata.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController {
	 ...
	 * 获取通知公告列表
	 */
	@PreAuthorize("@ss.hasPermit('system:notice:list')")
	@GetMapping("/list")
	 ...
	 * 根据通知公告编号获取详细信息
	 */
	@PreAuthorize("@ss.hasPermit('system:notice:query')")
	 ...
	 * 删除通知公告
	 */
	@PreAuthorize("@ss.hasPermit('system:notice:remove')")
