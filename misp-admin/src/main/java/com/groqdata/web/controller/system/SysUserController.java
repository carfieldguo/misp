...
public class SysUserController extends BaseController {
	...
	@PreAuthorize("@ss.hasPermit('system:user:export')")
	@PostMapping("/export")
	 ...
	 * 根据用户编号获取详细信息
	 */
	@PreAuthorize("@ss.hasPermit('system:user:query')")
	 ...
	 * 删除用户
	 */
	@PreAuthorize("@ss.hasPermit('system:user:remove')")
	 ...
	 * 重置密码
	 */
	@PreAuthorize("@ss.hasPermit('system:user:resetPwd')")
	@Log(title = "用户管理", businessType = BusinessType.UPDATE)
	@PutMapping("/resetPwd")
