...
public class ProviderUserInfoController extends BaseController {
	...
	@Autowired
	public void setProviderUserInfoService(ProviderUserInfoService providerUserInfoService) {
		this.providerUserInfoService = providerUserInfoService;
	}

	/**
	 * 查询账号信息列表
	 */
	@PreAuthorize("@ss.hasPermit('provider:user-info:list')")
	...
	public TableDataInfo<ProviderUserInfo> list(ProviderUserInfo providerUserInfo) {
		startPage();
	 ...
	 * 导出账号信息列表
	 */
	@PreAuthorize("@ss.hasPermit('provider:user-info:export')")
	...
	public void export(HttpServletResponse response, ProviderUserInfo providerUserInfo) {
		List<ProviderUserInfo> list = providerUserInfoService.selectProviderUserInfoList(providerUserInfo);
		ExcelUtil<ProviderUserInfo> util = new ExcelUtil<>(ProviderUserInfo.class);
	 ...
	 * 新增账号信息
	 */
	@PreAuthorize("@ss.hasPermit('provider:user-info:add')")
	@ApiOperation("新增账号信息")
	 ...
	 * 修改账号信息
	 */
	@PreAuthorize("@ss.hasPermit('provider:user-info:edit')")
	@ApiOperation("修改账号信息")
	 ...
	 * 删除账号信息
	 */
	@PreAuthorize("@ss.hasPermit('provider:user-info:remove')")
	@ApiOperation("删除账号信息")
