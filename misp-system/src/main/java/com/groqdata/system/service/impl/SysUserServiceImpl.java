...
import com.groqdata.common.utils.bean.BeanValidators;
import com.groqdata.common.utils.spring.SpringUtils;
import com.groqdata.system.domain.SysPost;
import com.groqdata.system.domain.SysUserPost;
...
import com.groqdata.system.mapper.SysUserMapper;
...
public class SysUserServiceImpl implements ISysUserService {
	...
	public boolean checkUserNameUnique(SysUser user) {
		Long userId = StringHelper.isNull(user.getUserId()) ? -1L : user.getUserId();
		SysUser info = userMapper.checkUserNameUnique(user.getUserName());
		if (StringHelper.isNotNull(info) && info.getUserId().longValue() != userId.longValue()) {
